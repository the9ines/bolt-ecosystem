...
| Rules | This file (and `os/rules/` from Phase 2) | Timeless. No versions, counts, or statuses. |
| Decisions & audits | `docs/` (frozen) until Phase 2 relocates | Dated records. Immutable. |
