...
> **Status:** Normative
> **Created:** 2026-03-08
> **Updated:** 2026-03-14 (RC7 IN-PROGRESS: CLI reservation hooks. AC-RC-29–32 PASS. AC-RC-33 BLOCKED on PM-RC-06.)
...
**Priority:** NEXT
**Status:** **RC1 DONE**, **RC2 DONE**, **RC3 DONE** (`daemon-v0.2.40`, 2026-03-14), **RC4 DONE** (`ecosystem-v0.1.130`, 2026-03-14), **RC5 DONE** (`daemon-v0.2.42-rustify-core1-rc5-btr-ws`, `sdk-v0.6.9-rustify-core1-rc5-ws-transport`, `ecosystem-v0.1.133-rustify-core1-rc5-done`, 2026-03-14). AC-RC-21–24 all PASS. **PM-RC-02 APPROVED** (WebSocket-direct, 2026-03-14). **RC6 DONE** (`ecosystem-v0.1.134-rustify-core1-rc6-executed`, 2026-03-14). AC-RC-25–28 all PASS. **PM-RC-03 APPROVED** (app-first rollout, 2026-03-14). **PM-RC-05 APPROVED** (deprecate-but-retain TS paths, 2026-03-14). **RC7 IN-PROGRESS** (2026-03-14). AC-RC-29–32 all PASS. AC-RC-33 **BLOCKED** on PM-RC-06.
...
**Acceptance Criteria:** 33 ACs defined (AC-RC-01 through AC-RC-33). RC1–RC7: AC-RC-01–32 all PASS/DONE (32 of 33 ACs delivered). AC-RC-33 BLOCKED on PM-RC-06. See `docs/GOVERNANCE_WORKSTREAMS.md` § RUSTIFY-CORE-1 for full list.
