...
> **Status:** Normative
> **Created:** 2026-03-08
> **Updated:** 2026-03-13 (RC2-EXEC-B — S1 conformance on Rust vectors: AC-RC-11 DONE)
...
NEXT:
  RUSTIFY-CORE-1 (native-first transport + core) ── RC1 DONE; RC2 GOV-DONE, EXEC-IN-PROGRESS (AC-RC-08/09/11 DONE, 2026-03-13)
