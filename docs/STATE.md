...
| SEC-DR1 | Double Ratchet pre-ByteBolt gate (DR-STREAM-1) | NEXT | bolt-core-sdk + bolt-protocol | **P0-DONE** (stream kickoff codified, `ecosystem-v0.1.99-sec-dr1-p0-codify`) |
