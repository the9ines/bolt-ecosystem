...
| SEC-BTR1 | Bolt Transfer Ratchet pre-ByteBolt gate (BTR-STREAM-1) | NEXT | bolt-core-sdk + bolt-protocol | **P0-DONE** (stream kickoff codified, `ecosystem-v0.1.100-sec-btr1-replaces-dr`) |
