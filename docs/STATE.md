...
> **Last Updated:** 2026-03-17 (RUSTIFY-BROWSER-CORE-1 RB3 DONE — Rust/WASM crypto+session authority.)
...
| RUSTIFY-BROWSER-CORE-1 | Browser-path Rust/WASM protocol authority | NEXT | bolt-core-sdk + bolt-transport-web + consumers + ecosystem | **RB3 DONE** (`sdk-v0.6.16` + `ecosystem-v0.1.168`, 2026-03-17). bolt-protocol-wasm: 61 KiB gzipped. TS SDK wired. 232 tests pass. RB4 READY. |
