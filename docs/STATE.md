...
> **Last Updated:** 2026-03-15 (EGUI-NATIVE-1 EN3 IN-PROGRESS: feature parity wired, placeholders removed, web tokens aligned. AC-EN-11/12/15 PARTIAL — daemon IPC needed.)
...
| EGUI-NATIVE-1 | Native desktop UI consolidation (egui) | LATER | localbolt-app + bolt-core-sdk + ecosystem | **EN1–EN2 DONE. EN3 IN-PROGRESS** (`sdk-v0.6.11`, 2026-03-15). AC-EN-11/12/15 PARTIAL (daemon IPC). |
