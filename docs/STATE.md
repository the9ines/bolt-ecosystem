...
> **Last Updated:** 2026-03-14 (RUSTIFY-CORE-1 RC5 IN-PROGRESS: Browser↔app WebSocket-direct integration. AC-RC-21/22/24 PASS, AC-RC-23 PARTIAL — WS boundary BTR-transparent but daemon missing `bolt.transfer-ratchet-v1` capability.)
...
| RUSTIFY-CORE-1 | Native-first transport + core consolidation | NEXT | bolt-core-sdk + bolt-daemon + bolt-protocol | **RC1 DONE**. **RC2 DONE**. **RC3 DONE** (`daemon-v0.2.40`). **RC4 DONE** (`ecosystem-v0.1.130`, 2026-03-14). **RC5 IN-PROGRESS** (`daemon-v0.2.41`, `sdk-v0.6.9`, `ecosystem-v0.1.132`, 2026-03-14). AC-RC-21/22/24 PASS, AC-RC-23 PARTIAL. **PM-RC-02 APPROVED** (WebSocket-direct, 2026-03-14). |
