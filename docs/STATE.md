...
> **Last Updated:** 2026-03-14 (RUSTIFY-CORE-1 RC3 DONE: quinn QUIC transport reference path implemented in bolt-daemon. AC-RC-12–16 all PASS. Tag: daemon-v0.2.40-rustify-core1-rc3-quinn-reference.)
...
| RUSTIFY-CORE-1 | Native-first transport + core consolidation | NEXT | bolt-core-sdk + bolt-daemon + bolt-protocol | **RC1 DONE**. **RC2 DONE** (`ecosystem-v0.1.127-rustify-core1-rc2-complete`). **RC3 DONE** (`daemon-v0.2.40-rustify-core1-rc3-quinn-reference`, 2026-03-14). Quinn QUIC transport adapter, BTR-over-QUIC verified, AC-RC-12–16 PASS, 381 tests zero regressions. 7 phases (RC1–RC7), 33 ACs, 8 PM decisions. |
