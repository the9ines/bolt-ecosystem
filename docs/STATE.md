...
> **Last Updated:** 2026-03-17 (RUSTIFY-BROWSER-ROLLOUT-1 codified — package/deploy/burn-in.)
...
| RUSTIFY-BROWSER-ROLLOUT-1 | Package + deploy + burn-in for browser WASM authority | NEXT | bolt-core-sdk + consumers + ecosystem | **CODIFIED** (`ecosystem-v0.1.172`, 2026-03-17). 6 phases (BR1–BR6), 17 ACs, 2 PM decisions. Operational follow-on. BR1 unblocked. |
