...
> **Last Updated:** 2026-03-09 (RECON-XFER-1 Phase A — transfer reconnect recovery fix)
...
| RECON-XFER-1 | Transfer reconnect recovery after mid-transfer disconnect | NOW | bolt-core-sdk (TS) + consumers | **PHASE-A-DONE** (`sdk-v0.5.35-recon-xfer1-phase-a-tests`, `v3.0.88-recon-xfer1-phase-a`) — Phase B: localbolt + localbolt-app verification pending |
