...
> **Last Updated:** 2026-03-18 (RUSTIFY-BROWSER-ROLLOUT-1 BR2 DONE — SDK published, localbolt-v3 consuming.)
...
| RUSTIFY-BROWSER-ROLLOUT-1 | Package + deploy + burn-in for browser WASM authority | NEXT | bolt-core-sdk + consumers + ecosystem | **BR2 DONE** (`ecosystem-v0.1.174`, 2026-03-18). bolt-core@0.6.0 + transport-web@0.7.0 published to npmjs. localbolt-v3 consuming. BR3 READY. |
