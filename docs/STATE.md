...
> **Last Updated:** 2026-03-11 (CBTR-F1 codified — receiver pause/resume defect blocks CBTR-2/3)
...
| CONSUMER-BTR1 | Consumer app BTR rollout (CONSUMER-BTR-1) | NOW | localbolt-v3, localbolt, localbolt-app | IN-PROGRESS. CBTR-1 P1 DONE. **BLOCKED on CBTR-F1** (receiver pause/resume — MEDIUM, OPEN). CBTR-2/3 cannot advance until fix lands + 24h burn-in. |
