...
> **Last Updated:** 2026-03-14 (RUSTIFY-CORE-1 RC5 DONE: Browser↔app WebSocket-direct integration. AC-RC-21–24 PASS. WS primary + WebRTC automatic fallback verified.)
...
| RUSTIFY-CORE-1 | Native-first transport + core consolidation | NEXT | bolt-core-sdk + bolt-daemon + bolt-protocol | **RC1 DONE**. **RC2 DONE**. **RC3 DONE** (`daemon-v0.2.40`). **RC4 DONE** (`ecosystem-v0.1.130`, 2026-03-14). **RC5 DONE** (`daemon-v0.2.39`, `ecosystem-v0.1.131`, 2026-03-14). AC-RC-12–24 PASS. **PM-RC-02 APPROVED** (WebSocket-direct, 2026-03-14). |
