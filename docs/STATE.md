...
> **Last Updated:** 2026-03-14 (PM-RC-02 APPROVED: WebSocket-direct for browser↔app transport. RC5 unblocked. Fallback: WS → WebRTC automatic.)
...
| RUSTIFY-CORE-1 | Native-first transport + core consolidation | NEXT | bolt-core-sdk + bolt-daemon + bolt-protocol | **RC1 DONE**. **RC2 DONE**. **RC3 DONE** (`daemon-v0.2.40`). **RC4 DONE** (`ecosystem-v0.1.130`, 2026-03-14). AC-RC-12–20 PASS. **PM-RC-02 APPROVED** (WebSocket-direct, 2026-03-14). **RC5 READY**. |
