...
| CONSUMER-BTR1 | Consumer app BTR rollout (CONSUMER-BTR-1) | NOW | localbolt-v3, localbolt, localbolt-app | IN-PROGRESS. CBTR-1 P1 DONE. CBTR-F1 FIXED (`sdk-v0.5.40`). CBTR-2/3 unblocked, awaiting 24h burn-in. |
