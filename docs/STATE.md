...
> **Last Updated:** 2026-03-13 (RC2-GOV executed — shared core API governance lock, ecosystem-v0.1.122-rustify-core1-rc2gov-executed)
...
| RUSTIFY-CORE-1 | Native-first transport + core consolidation | NEXT | bolt-core-sdk + bolt-daemon + bolt-protocol | **RC1 DONE** (`ecosystem-v0.1.120-rustify-core1-rc1-executed`, 2026-03-13). Transport matrix locked (app↔app: QUIC LOCKED). Rustification boundary locked. RC2 **GOV-DONE, EXEC-READY** (`ecosystem-v0.1.122-rustify-core1-rc2gov-executed`, 2026-03-13). Topology: direct multi-crate dependency (LOCKED). 7 phases (RC1–RC7), 33 ACs, 8 PM decisions. |
