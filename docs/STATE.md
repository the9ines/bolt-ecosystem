...
> **Last Updated:** 2026-03-14 (RUSTIFY-CORE-1 RC4 DONE: shared Rust core adoption verified across daemon, app, and TS boundaries. AC-RC-17–20 PASS. RC3+RC4 complete; RC5 blocked on PM-RC-02.)
...
| RUSTIFY-CORE-1 | Native-first transport + core consolidation | NEXT | bolt-core-sdk + bolt-daemon + bolt-protocol | **RC1 DONE**. **RC2 DONE**. **RC3 DONE** (`daemon-v0.2.40`). **RC4 DONE** (`ecosystem-v0.1.130`, 2026-03-14). AC-RC-12–20 PASS. Daemon shared-core authority, app IPC delegation, TS boundary, rollback all verified. RC5 blocked on PM-RC-02. |
