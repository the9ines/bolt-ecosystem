...
> **Last Updated:** 2026-03-13 (PM-RC-01 resolved — QUIC confirmed, RC2 READY, ecosystem-v0.1.121-rustify-core1-pmrc01-quic-locked)
...
| RUSTIFY-CORE-1 | Native-first transport + core consolidation | NEXT | bolt-core-sdk + bolt-daemon + bolt-protocol | **RC1 DONE** (`ecosystem-v0.1.120-rustify-core1-rc1-executed`, 2026-03-13). Transport matrix locked (app↔app: QUIC LOCKED). Rustification boundary locked. RC2 **READY** (PM-RC-01 APPROVED — QUIC confirmed, 2026-03-13). 7 phases (RC1–RC7), 33 ACs, 8 PM decisions (PM-RC-01A added). |
