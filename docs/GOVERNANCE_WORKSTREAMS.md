...
> **Status:** EN1 DONE. EN2 DONE. EN3 IN-PROGRESS (`sdk-v0.6.11`, 2026-03-15). AC-EN-11/12/15 PARTIAL — daemon IPC wiring required.
...
| **EN3** | Desktop feature parity migration (core screens/workflows) | Engineering gate | YES — gates EN4 | EN2 complete | **IN-PROGRESS** (`sdk-v0.6.11-egui-native1-en3-parity-wire`, 2026-03-15). AC-EN-10 PASS, AC-EN-13 PASS, AC-EN-14 PASS. AC-EN-11 PARTIAL, AC-EN-12 PARTIAL (daemon IPC). AC-EN-15 PARTIAL. |
...
| EGUI-NATIVE-1 | Native desktop UI consolidation (egui) | LATER | localbolt-app + bolt-core-sdk + ecosystem | **EN1–EN2 DONE. EN3 IN-PROGRESS** (`sdk-v0.6.11`, 2026-03-15). AC-EN-10/13/14 PASS. AC-EN-11/12/15 PARTIAL (daemon IPC). |
