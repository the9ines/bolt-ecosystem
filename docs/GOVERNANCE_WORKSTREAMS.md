...
> **Status:** EN1 DONE. EN2 DONE (`ecosystem-v0.1.150-egui-native1-en2-scaffold`, 2026-03-15). EN3 READY.
...
| **EN3** | Desktop feature parity migration (core screens/workflows) | Engineering gate | YES — gates EN4 | EN2 complete | **READY** (EN2 DONE, unblocked) |
