...
> **Status:** Normative
> **Created:** 2026-03-02
> **Updated:** 2026-03-19 (LOCALBOLT-RELIABILITY-UX-1 RU3 DONE — error/failure/retry UX)
> **Tag:** ecosystem-v0.1.182-localbolt-reliability-ux1-ru3-error-ux
...
> **Status:** RU3 DONE (`ecosystem-v0.1.182`, 2026-03-19). Error reasons, timeout messaging, retry context. RU4+RU5 READY.
...
| LOCALBOLT-RELIABILITY-UX-1 | Transfer reliability + UX hardening | NEXT | localbolt-v3 + bolt-transport-web + consumers + ecosystem | **RU3 DONE (`ecosystem-v0.1.182`, 2026-03-19). Error reasons, timeout messaging, retry context. RU4+RU5 READY. |
