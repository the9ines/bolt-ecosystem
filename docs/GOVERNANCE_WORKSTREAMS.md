...
> **Status:** Normative
> **Created:** 2026-03-02
> **Updated:** 2026-03-17 (RUSTIFY-BROWSER-CORE-1 RB4 DONE — BTR+transfer WASM authority, 102 KiB, 42μs/chunk)
> **Tag:** ecosystem-v0.1.169-rustify-browser-core1-rb4-done
...
> **Status:** RB4 DONE (`ecosystem-v0.1.169`, 2026-03-17). AC-RB-12–16 satisfied. BTR + transfer state authority in Rust/WASM. 102 KiB gzipped. Hot path: 42 μs/call (PRACTICAL). RB5 READY.
...
| RUSTIFY-BROWSER-CORE-1 | Browser-path Rust/WASM protocol authority | NEXT | bolt-core-sdk + bolt-transport-web + consumers + ecosystem | **RB4 DONE** (`sdk-v0.6.17` + `ecosystem-v0.1.169`, 2026-03-17). Full protocol authority in WASM: crypto + BTR + transfer SM. 102 KiB gzipped. Hot path: 42 μs/chunk (PRACTICAL). RB5 READY. |
