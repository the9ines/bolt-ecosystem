...
| LOCALBOLT-RELIABILITY-UX-1 | Transfer reliability + UX hardening | NEXT | localbolt-v3 + bolt-transport-web + consumers + ecosystem | **RU1 DONE** (`ecosystem-v0.1.180`, 2026-03-19). 10 issues prioritized (4 HIGH). Fix proposals defined. RU2 READY. |
